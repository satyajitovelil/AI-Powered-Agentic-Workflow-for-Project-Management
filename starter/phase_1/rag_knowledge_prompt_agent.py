...
chunks = rag_agent.chunk_text(knowledge_text)# TODO: 3 - Compute the knowledge_text the chunks
embbedings = rag_agent.calculate_embeddings()# TODO: 4 - Compute the knowledge_text the chunk embbedings
