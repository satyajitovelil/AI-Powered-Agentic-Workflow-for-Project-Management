...
evaluation_criteria_pm = (
    "The answer should follow this user story structure: "
...
routing_agent.agents = [
    {"name": "product_manager", "description": "Define user stories based on the product spec", "func": product_manager_support_function},
    {"name": "program_manager", "description": "Group user stories into product features", "func": program_manager_support_function},
    {"name": "dev_engineer", "description": "Define development tasks for each story", "func": development_engineer_support_function}
]
...
print(completed_steps[-1] if completed_steps else "No steps executed.")
